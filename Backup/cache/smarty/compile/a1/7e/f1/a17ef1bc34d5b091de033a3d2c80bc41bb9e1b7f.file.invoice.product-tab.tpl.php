<?php /* Smarty version Smarty-3.1.19, created on 2020-11-18 16:18:11
         compiled from "/var/www/html/prestashop/pdf/invoice.product-tab.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4521942365fb53b3370d147-21313814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a17ef1bc34d5b091de033a3d2c80bc41bb9e1b7f' => 
    array (
      0 => '/var/www/html/prestashop/pdf/invoice.product-tab.tpl',
      1 => 1452095428,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4521942365fb53b3370d147-21313814',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fb53b338708c2_40563078',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb53b338708c2_40563078')) {function content_5fb53b338708c2_40563078($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/var/www/html/prestashop/tools/smarty/plugins/function.cycle.php';
?>
...
%"><?php echo smartyTranslate(array('s'=>'Reference','pdf'=>'true'),$_smarty_tpl);?>
</th>
		<th class="product header small" width="<?php echo $_smarty_tpl->tpl_vars['layout']->value['product']['width'];?>
%"><?php echo smartyTranslate(array('s'=>'Product','pdf'=>'true'),$_smarty_tpl);?>
</th>
		<th class="product header small" width="<?php echo $_smarty_tpl->tpl_vars['layout']->value['tax_code']['width'];?>
%"><?php echo smartyTranslate(array('s'=>'Tax Rate','pdf'=>'true'),$_smarty_tpl);?>
</th>
...
%"><?php echo smartyTranslate(array('s'=>'Base price','pdf'=>'true'),$_smarty_tpl);?>
...
%"><?php echo smartyTranslate(array('s'=>'Qty','pdf'=>'true'),$_smarty_tpl);?>
</th>
...
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo smartyTranslate(array('s'=>'ecotax: %s','pdf'=>'true'),$_smarty_tpl);?>
...
<?php $_tmp3=ob_get_clean();?><?php echo sprintf($_tmp3,$_smarty_tpl->tpl_vars['customization_infos']->value['name']);?>
						...
						<?php if (isset($_smarty_tpl->tpl_vars['customization']->value['datas'][@constant('_CUSTOMIZE_FILE_')])&&count($_smarty_tpl->tpl_vars['customization']->value['datas'][@constant('_CUSTOMIZE_FILE_')])>0) {?>
							<table style="width: 100%;">
								<tr>
									<td style="width: 70%;"><?php echo smartyTranslate(array('s'=>'image(s):','pdf'=>'true'),$_smarty_tpl);?>
</td>
